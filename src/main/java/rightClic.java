...
public class rightClic {
	...
	public static void main(String[] args) {
		...
		WebElement move = driver.findElement(By.xpath("//*[@id=\"dm2m1i1tdT\"]"));
		action.moveToElement(move).perform();
		WebElement move1 = driver.findElement(By.xpath("//*[@id=\"dm2m2i1tdT\"]"));
		action.moveToElement(move1).perform();
		WebElement move2 = driver.findElement(By.xpath("//*[@id=\"dm2m3i1tdT\"]"));
